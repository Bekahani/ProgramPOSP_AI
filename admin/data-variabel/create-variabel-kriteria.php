              ...
              <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="POST" action="../../config/admin/inital-variabel/create.php">
                      <div class="form-group">
                        <label for="exampleInputUsername1">Nama Initial Variabel Data</label>
                        <input type="text" class="form-control" id="exampleInputUsername1" name="nama_initial_variabel">
                      </div>
                      <br>
